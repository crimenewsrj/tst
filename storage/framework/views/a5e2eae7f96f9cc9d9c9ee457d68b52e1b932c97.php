        ...
        <div class="section" style="margin-top: 15px;">
            <div class="section-page">
                <div class="quest-banner affiliate">
                    ...
                    <div class="info">
                    <?php $recompesa =  (float)env('RECOMPESA_DE_AFILIADOS'); ?>

                        <span>Indique um amigo e ganhe R$ <?php echo $recompesa; ?>,00 no primeiro depósito.</span></div>
                </div>
                        ...
                        <div class="affiliate-stats-item full">
                            <div class="wrap">
                                <div class="block">
                                    ...
                                    <span id="withdraw-button" class="" data-toggle="tooltip" data-placement="top" title="Quantidade mínima para retirada <?php echo e($settings->min_ref_withdraw); ?> R$ 50,00">
                                        <button type="button"<?php echo e($u->ref_money < $settings->min_ref_withdraw  ? 'disabled' : ''); ?> class="btn">Retirar</button>
                                    </span>
                                </div>
                            </div>
                        </div>
