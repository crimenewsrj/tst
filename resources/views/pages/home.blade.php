            ...
            <div class="intro-left">
                <div>
                    ...
                    <div class="intro-login">
                        ...
                        @else
                            <button type="button" id="loginRegister">Cadastrar
                            </button>
                        @endif
                ...
                <div class="swiper game-swiper">
                    <div class="swiper-wrapper" style="height: 1rm;">
                        ...
                        <div class="banners-slots">
                            @foreach($demo as $k => $v)
                                <div class="banner-slot-demo" data-game="{{ $v }}"><a href="{{ $v }}.php" onclick="alert('atençâo e somente para demonstração slots a ser implementado em breve!!!!')"><img src="../img/banners-games/{{ $v }}.png"/></a></div>
                            @endforeach
                        </div>
