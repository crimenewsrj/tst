                        ...
                        <div class="affiliate-stats-item full">
                            <div class="wrap">
                                <div class="block">
                                    ...
                                    <span id="withdraw-button" class="" data-toggle="tooltip" data-placement="top" title="Quantidade mínima para retirada {{ $settings->min_ref_withdraw }} R$ 50,00">
                                        <button type="button"{{ $u->ref_money < $settings->min_ref_withdraw  ? 'disabled' : '' }} class="btn">Retirar</button>
                                    </span>
                                </div>
                            </div>
                        </div>
